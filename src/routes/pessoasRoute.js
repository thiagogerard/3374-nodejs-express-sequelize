...
router.get('/pessoas/all', (req, res) => pessoaController.pegaTodasAsPessoas(req, res));
...
router.get('/pessoas/:estudante_id/matriculas/all', (req, res) => pessoaController.pegaTodasAsMatriculas(req, res));
